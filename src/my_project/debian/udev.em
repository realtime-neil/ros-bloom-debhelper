# /lib/udev/rules.d/60-@(Package).rules
#
# This is a udev rules file generated by bloom from the following template:
#
# ros-bloom-debhelper/src/my_project/debian/udev.em
